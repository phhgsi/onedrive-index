...
module.exports = {
  ...
  title: process.env.NEXT_PUBLIC_SITE_TITLE || 'Ajay-Index',
  ...
  footer:
  'Powered by <a href="https://github.com/phhgsi/onedrive-index" target="_blank" rel="noopener noreferrer">onedrive-index</a>.',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/phhgsi/onedrive-index',
    },
  ],
